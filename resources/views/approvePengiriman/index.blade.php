...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Approve Pengiriman</h5>
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                @if($data->prosesPengiriman!=2)
                  <a href="{{route('approvePengiriman.edit',[$data->idNotaPengiriman])}}" class="btn btn-primary btn-responsive">Approve</a>
                @endif
                </td>
